...
**Category:** Statistics
**Created:** 2025-10-23T14:55:50.816373

---

## Overview

Implement the Durbin-Watson test to detect first-order autocorrelation in the error terms of time series models. This is crucial when analyzing time-dependent data, like game statistics over a season.
...
class TestForAutocorrelationUsingTheDurbinWatsonS:
    """
    Test for Autocorrelation using the Durbin-Watson Statistic.
...
**Last Updated:** 2025-10-23T14:55:50.816378
