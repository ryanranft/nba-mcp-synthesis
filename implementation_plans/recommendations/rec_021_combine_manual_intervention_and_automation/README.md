# Combine Manual Intervention and Automation

**Status:** ⏳ PENDING IMPLEMENTATION
**Source Book:** Designing Machine Learning Systems
**Category:** Architecture
**Created:** 2025-10-18T17:01:54.039497

---

## Overview

Incorporate SMEs early into the process by empowering non-engineers to make changes on the model without requiring engineers. However, do not discount the need for specialized engineers!
...
class CombineManualInterventionAndAutomation:
    """
    Combine Manual Intervention and Automation.
...
**Last Updated:** 2025-10-18T17:01:54.039501
