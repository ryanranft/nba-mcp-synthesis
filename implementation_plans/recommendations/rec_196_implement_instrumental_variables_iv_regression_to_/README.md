...
**Category:** Statistics
**Created:** 2025-10-23T14:55:50.319082

---

## Overview

If there is suspicion that some of the independent variables are endogenous (correlated with the error term), use instrumental variables regression to obtain consistent estimates. For example, injuries might be correlated with performance and team tactics.  Find suitable instruments that are correlated with the endogenous variable but not with the error term (e.g., previous performance of the player's college team).
...
**Last Updated:** 2025-10-23T14:55:50.319087
