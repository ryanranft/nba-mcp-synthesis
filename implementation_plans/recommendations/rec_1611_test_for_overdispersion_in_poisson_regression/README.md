...
**Category:** Statistics
**Created:** 2025-10-23T14:55:50.830476

---

## Overview

After implementing Poisson regression, test for overdispersion. Overdispersion occurs when the variance of the count variable is greater than its mean, which violates the assumptions of the Poisson model.
...
class TestForOverdispersionInPoissonRegression:
    """
    Test for Overdispersion in Poisson Regression.
...
**Last Updated:** 2025-10-23T14:55:50.830481
