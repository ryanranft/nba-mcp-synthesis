...
**Category:** Statistics
**Created:** 2025-10-23T14:55:50.318191

---

## Overview

When analyzing binary outcomes (e.g., win/loss, made shot/missed shot), use a probit or logit model. These models ensure that the predicted probabilities are between 0 and 1.
...
class UseAProbitOrLogitModelForBinaryOutcomeAna:
    """
    Use a Probit or Logit Model for Binary Outcome Analysis.
...
**Last Updated:** 2025-10-23T14:55:50.318196
