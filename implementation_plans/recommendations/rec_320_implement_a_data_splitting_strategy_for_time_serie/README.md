# Implement a Data Splitting Strategy for Time Series Data

**Status:** ⏳ PENDING IMPLEMENTATION
**Source Book:** applied predictive modeling max kuhn kjell johnson 1518
**Category:** ML
**Created:** 2025-10-23T14:55:50.357640

---

## Overview

If the NBA analytics system involves time series data (e.g., game statistics over time), use a proper data splitting strategy such as rolling origin cross-validation or time series cross-validation to prevent data leakage and ensure reliable model evaluation.
...
class ImplementADataSplittingStrategyForTimeSerie:
    """
    Implement a Data Splitting Strategy for Time Series Data.
...
**Last Updated:** 2025-10-23T14:55:50.357645
