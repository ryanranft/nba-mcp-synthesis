...
**Category:** Statistics
**Created:** 2025-10-23T14:55:50.819948

---

## Overview

Implement Instrumental Variables (IV) regression to address endogeneity issues. Find variables that are correlated with the endogenous regressor but uncorrelated with the error term.
...
class InstrumentalVariablesIvRegression:
    """
    Instrumental Variables (IV) Regression.
...
**Last Updated:** 2025-10-23T14:55:50.819952
