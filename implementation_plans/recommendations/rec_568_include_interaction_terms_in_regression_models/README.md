...
**Category:** Statistics
**Created:** 2025-10-23T14:55:50.435580

---

## Overview

To capture non-additive effects of variables, include interaction terms in relevant regression models. This will allow for the effect of one variable to depend on the value of another variable (e.g., the effect of player height on scoring may differ based on player position).
...
class IncludeInteractionTermsInRegressionModels:
    """
    Include Interaction Terms in Regression Models.
...
**Last Updated:** 2025-10-23T14:55:50.435584
