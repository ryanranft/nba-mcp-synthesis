...
**Category:** Statistics
**Created:** 2025-10-23T14:55:50.448000

---

## Overview

If the outcome variable is binary (e.g., whether a player makes a shot or not), implement limited dependent variable models such as logit or probit regression. This is more appropriate than linear regression for binary outcomes.
...
class ImplementLimitedDependentVariableModelsLogitp:
    """
    Implement Limited Dependent Variable Models (Logit/Probit).
...
**Last Updated:** 2025-10-23T14:55:50.448005
