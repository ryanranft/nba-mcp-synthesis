...
**Category:** Statistics
**Created:** 2025-10-23T14:55:50.449272

---

## Overview

Use the Augmented Dickey-Fuller (ADF) test to determine if a time series is stationary. This is a crucial step before using time series data in regression models. Non-stationary time series can lead to spurious regression results.
...
**Last Updated:** 2025-10-23T14:55:50.449277
