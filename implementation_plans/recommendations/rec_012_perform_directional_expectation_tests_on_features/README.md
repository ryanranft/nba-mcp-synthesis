# Perform Directional Expectation Tests on Features

**Status:** ⏳ PENDING IMPLEMENTATION
**Source Book:** Designing Machine Learning Systems
**Category:** Testing
**Created:** 2025-10-18T17:01:54.036443

---

## Overview

Validate directional changes through manual calculation and automated tests, to ensure that changing the inputs causes the right change in the outputs. When working with inputs, keep all inputs the same except for a few to verify if they have the expected influence on the outputs.
...
class PerformDirectionalExpectationTestsOnFeatures:
    """
    Perform Directional Expectation Tests on Features.
...
**Last Updated:** 2025-10-18T17:01:54.036447
