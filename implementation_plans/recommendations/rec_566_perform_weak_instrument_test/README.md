# Perform Weak Instrument Test

**Status:** ⏳ PENDING IMPLEMENTATION
**Source Book:** ECONOMETRICS A Modern Approach
**Category:** Statistics
**Created:** 2025-10-23T14:55:50.435020

---

## Overview

After implementing Instrumental Variables (IV) regression, check for weak instruments using the first-stage F-statistic or Stock-Yogo weak instrument test. Weak instruments can lead to biased IV estimates.
...
class PerformWeakInstrumentTest:
    """
    Perform Weak Instrument Test.
...
**Last Updated:** 2025-10-23T14:55:50.435024
