# Make Use of a Backup System for High Latency Queries

**Status:** ⏳ PENDING IMPLEMENTATION
**Source Book:** Designing Machine Learning Systems
**Category:** Architecture
**Created:** 2025-10-18T17:01:54.037868

---

## Overview

If your main system is prone to high latency queries, implement an alternative system that generates predictions to give users predictions in a timely manner. A good alternative would be to use heuristics, simple models or cached precomputed predictions for a small user subset.
...
class MakeUseOfABackupSystemForHighLatencyQueri:
    """
    Make Use of a Backup System for High Latency Queries.
...
**Last Updated:** 2025-10-18T17:01:54.037873
