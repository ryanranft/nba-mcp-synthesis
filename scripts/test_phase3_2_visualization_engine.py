...
async def test_visualization_tools():
    ...
    try:
        ...
        assert result['success'], f"visualization_generate (scatter) failed: {result['error']}"
        ...
        result = result_tuple[1]
        assert result['success'], f"visualization_generate (bar) failed: {result['error']}"
        ...
        result = result_tuple[1]
        assert result['success'], f"visualization_generate (heatmap) failed: {result['error']}"
        ...
        result = result_tuple[1]
        assert result['success'], f"visualization_generate (latex) failed: {result['error']}"
        ...
        result = result_tuple[1]
        assert result['success'], f"visualization_get_templates failed: {result['error']}"
        ...
        result = result_tuple[1]
        assert result['success'], f"visualization_get_templates (specific) failed: {result['error']}"
        ...
        logger.info(f"Retrieved config: {result['config']['width']}x{result['config']['height']}")
        ...
        result = result_tuple[1]
        assert result['success'], f"visualization_create_data_point failed: {result['error']}"
        ...
        result = result_tuple[1]
        assert result['success'], f"visualization_create_dataset failed: {result['error']}"
        ...
        logger.info(f"Created dataset: {result['dataset']['name']} with {result['data_points_count']} points")
        ...
        result = result_tuple[1]
        assert not result['success'], f"Invalid visualization type should fail: {result}"
