...
CATEGORIES = {
    ...
    "ml_clustering": ["ml_kmeans", "ml_hierarchical", "ml_euclidean", "ml_cosine"],
    "ml_classification": [
        "ml_knn",
        "ml_naive_bayes",
        "ml_decision_tree",
    ...
    "ml_anomaly": ["ml_zscore", "ml_isolation_forest", "ml_local_outlier"],
    "ml_preprocessing": ["ml_normalize", "ml_feature_importance"],
    "ml_evaluation": [
        "ml_accuracy",
        "ml_precision_recall",
        "ml_confusion_matrix",
    ...
    "ml_validation": [
        "ml_k_fold",
        "ml_stratified_k_fold",
        "ml_cross_validate",
        "ml_compare_models",
        "ml_paired_ttest",
        "ml_grid_search",
    ],
    "ml_regression": ["stats_linear_regression", "stats_predict"],
    "s3": ["list_s3_files", "s3_"],
}
...
def main():
    ...
    print(
        f"Categories: {len(by_category) - (1 if 'uncategorized' in by_category else 0)}"
    )
    print("=" * 70)
