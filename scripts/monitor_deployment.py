...
class DeploymentMonitor:
    ...
    def _get_file_counts(self) -> Dict[str, int]:
        ...
        try:
            ...
            if os.path.exists(phases_dir):
                ...
                counts['total'] = counts['python'] + counts['tests'] + counts['sql'] + counts['yaml'] + counts['guides']
    ...
    def _launch_deployment(self):
        ...
        print(f"{self.COLORS['CYAN']}Launching Multi-Pass Book Deployment...{self.COLORS['END']}")
        ...
        print(f"{self.COLORS['GREEN']}Deployment launched successfully!{self.COLORS['END']}")
    ...
    def _display_progress(self, progress: Dict[str, Any]):
        ...
        if pass_name:
            print(f"Current Pass: {self.COLORS['BLUE']}{current_pass} - {pass_name}{self.COLORS['END']}")
        else:
            print(f"Current Pass: {self.COLORS['BLUE']}{current_pass}{self.COLORS['END']}")
        ...
        print(f"{self.COLORS['WHITE']}Press Ctrl+C to stop monitoring{self.COLORS['END']}")
    ...
    def run(self):
        ...
        print(f"{self.COLORS['BOLD']}{self.COLORS['CYAN']}Starting Multi-Pass Book Deployment Monitor{self.COLORS['END']}")
        ...
        while self.running:
            try:
                ...
                if progress:
                    ...
                    self._clear_screen()
                    print(f"{self.COLORS['YELLOW']}Waiting for deployment to start...{self.COLORS['END']}")
