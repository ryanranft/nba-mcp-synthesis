...
class WorkflowDashboard:
    ...
    def update_book_progress(self, books_analyzed: int, total_books: int):
        ...
        should_update = (
            percentage % 25 == 0 or
            books_analyzed % 5 == 0 or
            books_analyzed == total_books
        )
    ...
    async def _send_progress_update(self):
        ...
        try:
            ...
            percentage = (self.progress['books_analyzed'] / self.progress['total_books']) * 100
    ...
    def get_progress_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'elapsed_minutes': (datetime.now() - self.progress['start_time']).total_seconds() / 60 if self.progress['start_time'] else 0
        }
