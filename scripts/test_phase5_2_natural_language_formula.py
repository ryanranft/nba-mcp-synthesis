...
class TestNaturalLanguageFormula(unittest.TestCase):
        ...
        self.test_cases = [
            {
                ...
                "expected_variables": ["PTS", "REB", "AST", "STL", "BLK", "FGA", "FGM", "FTA", "FTM", "TOV", "MP"],
    ...
    async def test_parse_natural_language_formula(self):
        ...
        for i, test_case in enumerate(self.test_cases, 1):
            ...
            try:
                ...
                self.assertGreater(found_vars, 0,
    ...
    async def test_validate_natural_language_formula(self):
        ...
        validation_tests = [
            {
                "description": "field goal percentage",
                "expected_formula": "FGM / FGA"
            },
            {
                "description": "points plus rebounds",
                "expected_formula": "PTS + REB"
            },
            {
                "description": "assist to turnover ratio",
    ...
    async def test_error_handling(self):
        ...
        for i, description in enumerate(error_tests, 1):
            ...
            try:
                ...
                logger.info(f"✓ Error handling test {i} - got result with status: {result.get('status', 'unknown')}")
