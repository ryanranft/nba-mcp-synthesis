...
class TestInteractiveFormulaBuilder(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_values = {
            "PTS": 25.0, "FGA": 15.0, "FTA": 6.0, "FGM": 8.0, "3PM": 2.0,
            "FTM": 5.0, "BLK": 1.0, "OREB": 1.0, "AST": 8.0, "DREB": 7.0,
            "PF": 2.0, "TOV": 3.0, "MP": 38.0, "TM_MP": 240.0, "TM_FGA": 90.0,
            "TM_FTA": 25.0, "TM_TOV": 12.0, "TM_FGM": 35.0, "TM_REB": 45.0,
            "OPP_REB": 42.0, "OPP_POSS": 100.0, "OPP_2PA": 50.0, "STL": 2.0,
            "ORtg": 115.0, "DRtg": 108.0
        }
    ...
    def test_completion_suggestions(self):
        ...
        self.assertTrue(any("0.44" in s or "fta" in s or ")" in s for s in suggestion_texts))
    ...
    def test_formula_preview(self):
        ...
        preview_with_values = self.builder.get_formula_preview(formula, self.test_values)
    ...
    def test_template_creation(self):
        ...
        result = self.builder.create_formula_from_template(template_name, variable_values)
    ...
    def test_variable_validation(self):
        ...
        valid_variables = ["PTS", "FGA", "FTA", "FGM", "3PM", "FTM", "BLK", "OREB", "AST", "DREB"]
    ...
    def test_error_handling(self):
        ...
        result = self.builder.create_formula_from_template("True Shooting Percentage", invalid_values)
    ...
    def test_complex_formula_handling(self):
        ...
        # Test validation
        result = self.builder.validate_formula(complex_formula, ValidationLevel.SEMANTIC)
        self.assertIsInstance(result, FormulaValidation)
        self.assertTrue(result.is_valid)
    ...
    def test_performance(self):
        ...
        start_time = time.time()
        for _ in range(100):
            self.builder.validate_formula(self.test_formulas["simple"], ValidationLevel.SYNTAX)
        end_time = time.time()
    ...
    def test_integration_with_formula_intelligence(self):
        ...
        validation_result = self.builder.validate_formula(formula, ValidationLevel.SPORTS_CONTEXT)
        
        self.assertIsInstance(validation_result, FormulaValidation)
        self.assertTrue(validation_result.is_valid)
        
        # Test suggestions integration
        suggestions = self.builder.suggest_completion("PTS / (2 * (FGA +", "shooting efficiency")
