        ...
        routes=[
            {
                ...
                "route": [
                    {
                        "destination": {"host": "nba-mcp-service", "subset": "v2"},
                        "weight": 100,
                    }
                ],
            },
            {
                "route": [
                    {
                        "destination": {"host": "nba-mcp-service", "subset": "v1"},
                        "weight": 90,
                    },
                    {
                        "destination": {"host": "nba-mcp-service", "subset": "v2"},
